...
namespace Akka.Interfaced.SlimSocket.Server.SessionChannel
{
    ...
    {
        private readonly SessionGatewayInitiator _initiator;
        ...
        public SessionGateway(SessionGatewayInitiator initiator)
        {
        ...
        IRequestTarget IActorBoundGatewaySync.OpenChannel(IActorRef actor, TaggedType[] types, object tag, ActorBindingFlags bindingFlags)
        {
            ...
            var address = string.Join("|", SessionChannelType.TypeName,
