...
namespace Akka.Interfaced.SlimSocket.Server.TcpChannel
{
    ...
    {
        private TcpGatewayInitiator _initiator;
        ...
        public TcpChannel(TcpGatewayInitiator initiator, Socket socket, object tag)
        {
        ...
        public TcpChannel(TcpGatewayInitiator initiator, TcpConnection connection, object tag, Tuple<IActorRef, TaggedType[], ActorBindingFlags> bindingActor)
        {
