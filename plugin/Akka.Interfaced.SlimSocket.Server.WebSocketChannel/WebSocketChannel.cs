...
namespace Akka.Interfaced.SlimSocket.Server.WebSocketChannel
{
    ...
    {
        private WebSocketGatewayInitiator _initiator;
        ...
        public WebSocketChannel(WebSocketGatewayInitiator initiator, AcceptedWebSocket acceptedWebSocket, object tag)
        {
        ...
        public WebSocketChannel(WebSocketGatewayInitiator initiator, WebSocketConnection connection, object tag, Tuple<IActorRef, TaggedType[], ActorBindingFlags> bindingActor)
        {
