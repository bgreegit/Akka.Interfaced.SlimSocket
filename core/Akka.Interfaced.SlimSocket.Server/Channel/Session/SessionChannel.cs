...
namespace Akka.Interfaced.SlimSocket.Server
{
    public class SessionChannel : ActorBoundChannelBase
    {
        ...
        public SessionChannel(GatewayInitiator initiator, int sessionId, EndPoint remoteEndPoint, object tag, Tuple<IActorRef, TaggedType[], ActorBindingFlags> bindingActor)
        {
